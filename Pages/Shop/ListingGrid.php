				...
				<div class="row">
					...
					<nav class="col-md-8"> 
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="index.php?page=listinggrid">Listing Grid</a></li>
							<?php
								$catid1 = 0;
								if(isset($_GET['catid'])){
									$catid1 = $_GET['catid'];
									
									$sql1 = "SELECT * FROM CATEGORY WHERE ID = $catid1";
									$result1 = $core->getOne($sql1);
							?>
									<li class="breadcrumb-item">
										<a href="index.php?page=listinggrid&catid=<?=$catid1?>
											">
											<?=$result1['category_name']?>
										</a>
									</li>
							<?php
								}
		...
		<header class="mb-3">
				<div class="form-inline">
					...
					<div class="btn-group">
						...
						<a href="index.php?page=listinggrid" class="btn btn-light active" data-toggle="tooltip" title="Grid view"> 
			...
			<div class="col-md-3">
				<figure class="card card-product-grid">
					...
					<figcaption class="info-wrap">
							...
							<a href="index.php?page=detail&id=<?=$product['id']?>" class="btn btn-outline-primary" style="float:right;"> Detail </a>
					</figcaption>
				</figure>
			</div> <!-- col.// -->
			<!-- PHP -->	
				...
				<ul class="pagination">
					<li class="page-item <?=$_SESSION['trang']==1?'disabled':'active'?>">
						...
						<div class="page-link flex flex-col items-center" class="">
							<form method="post" action="index.php?page=listinggrid<?=isset($_GET['catid'])?'&catid='.$_GET['catid']:''?>">
