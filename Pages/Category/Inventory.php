...
<?php 
	//get 
    $sql = "SELECT * FROM product, category WHERE product.cat_id = category.id AND category.id = 4";
   // đếm tổng sản phẩm
   $sqlCount = "SELECT COUNT(*) FROM product, category WHERE product.cat_id = category.id AND category.id = 4";
