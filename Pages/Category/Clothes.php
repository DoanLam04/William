...
<?php 
	//get 
    $sql = "SELECT * FROM product, category WHERE product.cat_id = category.id AND category.id = 1";
   // đếm tổng sản phẩm
   $sqlCount = "SELECT COUNT(*) FROM product, category WHERE product.cat_id = category.id AND category.id = 1";
				...
				<div class="row">
					...
					<nav class="col-md-8"> 
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="index.php?page=clothes">Listing Grid</a></li>
							<li class="breadcrumb-item"><a href="index.php?page=clothes">Clothes</a></li>
		...
		<header class="mb-3">
				<div class="form-inline">
					...
					<div class="btn-group">
						...
						<a href="index.php?page=clothes" class="btn btn-light active" data-toggle="tooltip" title="Grid view"> 
				...
				<ul class="pagination">
					<li class="page-item <?=$_SESSION['trang']==1?'disabled':'active'?>">
						...
						<div class="page-link flex flex-col items-center" class="">
							<form method="post" action="index.php?page=clothes">
